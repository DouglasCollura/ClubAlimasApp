<template>
  <base-layout>
    <div class="container grid">
      <div class="grid" v-show="fase == 0">
        <div class="temp-cupon">
          <button
            ...
            class="back-button back-button-green icon-arrow-back align-self-start justify-self-start"
          ></button>
          ...
          <div class="section-cupon-img">
            ...
            <div>
              <h1 class="text-green font-300" style="word-break: break-word">
                {{ cupon.titulo }}
              </h1>
          ...
          <div class="grid gc-2x-g">
            <div>
              <h3>
                <i class="icon-locacion text-green"></i> {{ cupon.direccion }}
              </h3>
            </div>

            <div class="justify-self-center">
              <h2>
                <i class="icon-telefono text-green"></i> {{ cupon.telefono }}
              </h2>
            </div>
          </div>
          ...
          <div class="card-cupon-valor">
            <h1 class="text-center">
              Valor en puntos: {{ numeroFormateado(cupon.puntos) }}
            </h1>
          </div>
          ...
          <div class="info-cupon">
            ...
            <h3 class="font-400">
              Presiona el botón de canjear puntos. De esa forma estarás
              canjeando puntos por el cupón. Una vez realizado esto, se generará
              un código para que utilices en el comercio.
            </h3>
          </div>
        </div>
        ...
        <div class="section-cupon-footer">
          ...
          <h2
            ...
            class="text-green align-self-end font-400 text-center"
          ...
          <h2
            ...
            style="font-size: 40px"
          >
            S/. {{ numeroFormateado(cupon.precio, 2) }} de descuento
          </h2>

          <button class="btn btn-secondary" @click="fase = 1">
            CANJEAR PUNTOS
          </button>
        </div>
      </div>
      ...
      <div
        v-show="fase == 1"
        class="grid align-content-center justify-items-center"
        style="padding: 20px; grid-gap: 30px"
      >
        <h1 class="text-center font-400">
          Estas por cambiar {{ numeroFormateado(cupon.puntos) }} puntos por el cupón ¿Deseas
          continuar?
        </h1>
      ...
      <div
        v-if="fase == 2"
        class="container grid align-content-start justify-items-center"
        style="grid-gap: 20px; padding: 10px"
      >
        <button
          @click="this.$emit('Return')"
          class="back-button text-orange icon-close align-self-start justify-self-end"
        ></button>

        <h1 class="font-400 text-center text-green">
          ¡Cupón generado! ¡Y listo para usar!
        </h1>

        <div class="QR-container">
          <vueQr
            :text="'http://programa.calimas.pe/' + 'Canje/' + cod_qr"
            :size="200"
          ></vueQr>
        </div>
        ...
        <div class="section-cupon-img" style="justify-self: stretch">
          <div
            class="grid justify-self-center align-self-start card-img"
        ...
        <div class="card-cupon-valor" style="justify-self: stretch">
          <h2 class="text-center">
            Vencimiento: {{ cupon.fecha_hasta.split("-").reverse().join("-") }}
          </h2>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    async Insert() {
      ...
      await axios
        .post(process.env.VUE_APP_API + "InsertBeneficioCtrl", params)
        .then((response) => {
